...
1.	Qype (iOS): 
This is the best application to find the right place. Whatever you’re looking for (restaurants, bars, shops, doctors, hotels...) it's all on Qype, along with user-generated ratings and reviews to get detailed insider information and tips on where to go. (Text copied from Naveed Ahsan’s LinkedIn profile)
